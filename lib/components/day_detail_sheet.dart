...
class _DayDetailSheetState extends State<DayDetailSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final dateLabel =
        '${dateObj.month}月${dateObj.day}日 周${weekDays[dateObj.weekday - 1]}';
  ...
  Widget _habitTile(
      Map<String, dynamic> h, ColorScheme colorScheme, bool isDark) {
    ...
    return ListTile(
      ...
      title: Text(name,
          style: TextStyle(
              fontSize: 14,
              fontWeight:
                  status != null ? FontWeight.w500 : FontWeight.normal,
              color: status == null
